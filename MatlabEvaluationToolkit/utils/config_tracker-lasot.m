...
trackers = {struct('name', 'BACF',       'publish', 'ICCV-17') ...
            ...
            struct('name', 'ATOM',       'publish', 'CVPR-19')...
            struct('name', 'DiMP',       'publish', 'ICCV-19')...
            struct('name', 'C-RPN',      'publish', 'CVPR-19')...
            struct('name', 'SiamRPN++',  'publish', 'CVPR-19')...
            struct('name', 'DaSiamRPN',  'publish', 'ECCV-18')...
            struct('name', 'D-STRCF',    'publish', 'CVPR-18')...
            struct('name', 'SiamDW',     'publish', 'CVPR-19')...
            struct('name', 'GFSDCF',     'publish', 'ICCV-19')...
            struct('name', 'SiamMask',   'publish', 'CVPR-19')...
            struct('name', 'GlobalTrack','publish', 'AAAI-20') ...
            struct('name', 'SPLT',       'publish', 'ICCV-19') ...
            struct('name', 'ASRCF',      'publish', 'CVPR-19') ...
            struct('name', 'LTMU',       'publish', 'CVPR-20')
            };
end