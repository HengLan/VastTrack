...
**Figure:** We introduce [**VastTrack**](https://arxiv.org/abs/2403.03493), a new large-scale benchmark that aims to facilitate general single object tracking with abundant object categories (over **2.1K classes**) and videos (**over 50K sequences**). Here we show partial target trajectories in videos. <em>Please notice that, only a very small part of categories and videos are demonstrated</em>.
...
* **OneDrive**
  ...
  - The downloading link for the **`test set`** is [here](https://yangtzeueducn-my.sharepoint.com/:f:/g/personal/2022720528_yangtzeu_edu_cn/EtOz2Y3xgnlHk1d4pyVLtpYB1k54nzeHMQjPoOFqJTbfcQ?e=u7O89m).
