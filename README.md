...
To validate if the downloaded files are complete or not, please refer to the MD5 files ([MD5-Training](https://github.com/HengLan/VastTrack/blob/main/assets/train_md5.txt) and MD5-Test (to be uploaded)).
